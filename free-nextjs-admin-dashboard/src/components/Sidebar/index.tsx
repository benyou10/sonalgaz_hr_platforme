  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
         <h1 className="text-blue-900 text-3xl font-extrabold dark:text-white text-center">Sonalgaz</h1>
        </Link>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out text-black dark:text-white hover:bg-graydark dark:hover:bg-meta-4 ${
