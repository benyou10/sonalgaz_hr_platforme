...
export default function SideNav(){
    ...
    return(
      ...
      {/* component */}
      <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-transparent text-gray-800">
        <div className=" flex  flex-col top-0 left-0  bg-transparent h-full ">
